...
Parser.prototype = {
    ...
    parse: function(options) {
        ...
        return this._actions
            .waitPromiseWithUnexpectedNavigationHandlers(() => this._env.prepare())
            .then(function() {
    ...
    /**
     * @see {@link Actions#addUnexpectedNavigationHandler}
     */
    addUnexpectedNavigationHandler() {
        return this._actions.addUnexpectedNavigationHandler.apply(this._actions, arguments)
    },
