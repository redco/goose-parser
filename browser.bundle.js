...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1);
	(function webpackMissingModule() { throw new Error("Cannot find module \"browser.bundle.js\""); }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debugLib = __webpack_require__(7),
	    ...
	    Transformations = __webpack_require__(16),
	...
	Parser.prototype = {
	        ...
	        return this._actions.performForRule(rule, selector).then(function (actionsResults) {
	            ...
	            if (rule.rulesFromActions) {
	                ...
	                if ('scope' in actionsResults) {
	                    _this2._pushScope(actionsResults.scope, actionsResults.parentScope);
	                    scopePushed = true;
	                }
	                ...
	                if ('actions' in rule) {
	                    promise = promise.then(function () {
	                        return _this2._actions.performForRule(rule, selector);
	                    });
	                }
	            }

	            promise = promise.then(function () {
	                return _this2._parseScope(rule, offset, actionsResults);
	            });
	    ...
	    _parseScope: function _parseScope(rule, offset, actionsResults) {
	        ...
	        var extract = function extract(results, ruleType, dataType) {
	            if (ruleType === _this3.TYPES.SIMPLE && dataType === 'array' && Array.isArray(results) && results.length === 1 && Array.isArray(results[0])) {
	        ...
	        var format = function format(results) {
	            if (_.contains([_this3.TYPES.SIMPLE, _this3.TYPES.GET, _this3.TYPES.VALUE, _this3.TYPES.COLLECTION], ruleType)) {
	        ...
	        var setResultsToStore = function setResultsToStore(results) {
	            if (rule.set) {
	                _this3._actions.set(rule.set, results);
	            }
	            return results;
	        };

	        if (!rule.transform) {
	            return resultsPromise.then(format).then(setResultsToStore);
	        }
	        ...
	        return resultsPromise.then(function (results) {
	            ...
	            return format(_this3._transforms.produce(rule.transform, results));
	        }).then(function (results) {
	    ...
	    _injectBrowserRule: function _injectBrowserRule(rule, offset, actionsResults) {
	        ...
	        return this._env.injectBrowserEnv().then(function () {
	            return _this4._env.evaluateJs(rule, offset, _this4._scopes, function (rule, offset, scopes) {
	                __gooseParse(rule, offset, scopes);
	            });
	        }).then(function () {
	            return _this4._actions.wait(function () {
	    ...
	    _parseCollectionRule: function _parseCollectionRule(rule) {
	        ...
	        return collection.reduce(function (promise, rule) {
	            return promise.then(self._processRule.bind(self, rule)).then(function (result) {
	                var name;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Actions.prototype = {
	    ...
	    changeElement: function changeElement(selector, changeStyleOptions) {
	     ...
	     * @returns {Promise}
	     */
	    waitElement: function waitElement(selector, timeout, interval) {
	     ...
	     * @returns {Promise}
	     */
	    waitElementIsVisible: function waitElementIsVisible(selector, timeout, interval) {
	     ...
	     * @returns {Promise}
	     */
	    waitForPattern: function waitForPattern(selector, pattern, timeout, interval) {
	    ...
	    wait: function wait(evalFunction, checkerFunction, args, timeout, interval) {
	        ...
	        var _errback = function errback(msg) {
	            clearTimeout(timeoutId);
	        ...
	        var timeoutId = setTimeout(function () {
	            _this3._env.removeErrback(_errback);
	            clearInterval(intervalId);
	        ...
	        this._env.addErrback(_errback);

	        var evalArgs = args.slice(0);
	        evalArgs.push(evalFunction);
	        var intervalId = setInterval(function () {
	            _this3._env.evaluateJs.apply(_this3._env, evalArgs).then(function () {
	                if (checkerFunction.apply(null, arguments)) {
	                    clearTimeout(timeoutId);
	                    clearInterval(intervalId);
	                    this._env.removeErrback(_errback);
	                    deferred.resolve();
	                    _errback = null;
	                    deferred = null;
	                    checkerFunction = null;
	    ...
	    mouseClick: function mouseClick(selector) {
	     ...
	     * @returns {Promise}
	     */
	    mousedown: function mousedown(selector) {
	     ...
	     * @returns {Promise}
	     */
	    mouseup: function mouseup(selector) {
	     ...
	     * @returns {Promise}
	     */
	    type: function type(selector, text) {
	     ...
	     * @returns {Promise}
	     */
	    waitForQuery: function waitForQuery(uri, timeout) {
	     ...
	     * @returns {Promise}
	     */
	    exist: function exist(selector, child) {
